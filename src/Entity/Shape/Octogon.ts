...
/**
 * Octogon entity class.
 */
export default class Octogon extends AbstractShape {
    /** If the octogon is an alpha octogon or not */
    ...
    public constructor(game: GameServer, isAlpha=false, shiny=(Math.random() < 0.000001) && !isAlpha) {
        ...
        this.nameData.values.name = isAlpha ? "Alpha Octogon" : "Octogon";

        this.healthData.values.health = this.healthData.values.maxHealth = (isAlpha ? 9000 : 300);
        this.physicsData.values.size = (isAlpha ? 250 : 100) * Math.SQRT1_2;
        this.physicsData.values.sides = 8;
        this.styleData.values.color = shiny ? Color.Shiny : Color.EnemyOctogon;
        ...
        this.damagePerTick = isAlpha ? 16 : 9;
        this.scoreReward = isAlpha ? 11000 : 500;
