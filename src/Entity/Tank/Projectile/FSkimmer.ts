 ...
 */
const FSkimmerBarrelDefinition: BarrelDefinition = {
    angle: Math.PI / 2,
    offset: 0,
    size: 70,
    width: 42,
 ...
 */
export default class FSkimmer extends Bullet implements BarrelBase {
    /** Default speed the skimmer spins */
    public static BASE_ROTATION = 0.1;

    /** The skimmer's barrels */
    private fskimmerBarrels: Barrel[];
    ...
    private rotationPerTick = FSkimmer.BASE_ROTATION;
    ...
    public constructor(barrel: Barrel, tank: BarrelBase, tankDefinition: TankDefinition | null, shootAngle: number, direction: number) {
        ...
        const fskimmerBarrels: Barrel[] = this.fskimmerBarrels =[];
        ...
        }(this, {...FSkimmerBarrelDefinition});
        const s2Definition = {...FSkimmerBarrelDefinition};
