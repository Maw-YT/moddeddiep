...
import FSkimmer from "./Projectile/FSkimmer";
import MSummoner from "./Projectile/MSummoner";
    ...
    public shoot() {
        ...
        switch (this.definition.bullet.type) {
            ...
            case 'minion':
                ...
                break;
            case 'msummoner':
                new MSummoner(this, this.tank, tankDefinition, angle);
                break;
            case 'flame':
            ...
            case "croc": 
                ...
                break;
            case "fskimmer":
                new FSkimmer(this, this.tank, tankDefinition, angle, this.tank.inputs.attemptingRepel() ? -FSkimmer.BASE_ROTATION : FSkimmer.BASE_ROTATION);
                break;
            default:
